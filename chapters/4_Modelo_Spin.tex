...
${\bf{J}}_{bh}$ juega un papel crucial en regiones cercanas al BH, indica la eficiencia de convertir la materia en radiación en un disco de acreción, se cree además que su dirección está relacionada con la dirección del jet de AGN \cite{fanidakis2011}. 
...
\figcaption{\emph{Modelo de evolución de espín considerando un sistema auto-gravitante, en la parte exterior a la región warp se forma una distribución de gas, la cual es gobernada por una dinámica auto-gravitante \cite{Bustamante2018b}. }}
