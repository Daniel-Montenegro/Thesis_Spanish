...
\figcaption{\emph{Radiación cósmica de fondo\cite{bennett2003}.}}\label{fig:radiación_cosmica_de_fondo}
\end{center}

- El segundo principio cosmológico trata sobre la dinámica de las sobre densidades en el universo, el cual enuncia que el  movimiento es despreciables cuando se compara con el movimiento cosmológico. El segundo principio se denomina como Postulado de Weyl \cite{janssen2013} %el cual dice: \\
...
\figcaption{\emph{Representación del diferencial de línea para simetría esférica\cite{longair2008}.}}\label{fig:diferencial_linea_esferico}
\end{center}
...
\figcaption{\emph{Tres espacios con curvatura constante, esfera con curvatura positiva (izquierda), hiperboloide con curvatura negativa (centro) y plano con curvatura cero (derecha). \url{https://bit.ly/2Moqlnr}. }}
...
\figcaption{\emph{Comparación entre el modelo de N-cuerpos (a) y la aproximación de Zeldovich \cite{coles2002}, para las mismas condiciones iniciales; Dejando ver la alta similitud y la buena aproximación del método de Zeldovich en el régimen no lineal. }}\label{fig:diferencial_linea_esferico}
\end{center}
