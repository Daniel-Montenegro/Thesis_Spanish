...
\includegraphics[width=0.4\textwidth]{./figures/5_Algoritmo_Modelacion/Distribution_density_inferior.png}} 
\subfloat{ 
%\label{fig: función de masa BHs}
\includegraphics[width=0.4\textwidth]{./figures/5_Algoritmo_Modelacion/Distribution_density_media.png}} 
\subfloat{ 
%\label{fig: función de masa halos}
\includegraphics[width=0.4\textwidth]{./figures/5_Algoritmo_Modelacion/Distribution_density_superior.png}}
\caption{Distribución del campo de sobre densidad, resultado del modelo T-Web, las figuras son cortes en el eje $z$ a diferentes alturas. La figura superior izquierda representa un corte inferior, la superior derecha un corte medio  y la inferior da cuenta del corte superior.} 
